...
/// `SkillTests` check it against the CLI's own help. The text is the website's
/// `/cli/skill/SKILL.md` as approved for launch (website #31, at a97f8ca). The two must stay
/// identical: a change to the wording lands in both.
enum MarsDawnSkill {
    static let text = #"""
---
name: marsdawn
