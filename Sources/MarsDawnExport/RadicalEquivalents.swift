// Generated from the Unicode Character Database file EquivalentUnifiedIdeograph.txt
// (EquivalentUnifiedIdeograph-18.0.0.txt, Date: 2026-02-03), keeping only the CJK Radicals Supplement
// (U+2E80–U+2EFF) and Kangxi Radicals (U+2F00–U+2FDF) entries.
// © 2026 Unicode®, Inc. Terms of use: https://www.unicode.org/terms_of_use.html

/// Each CJK radical that has a visually identical unified ideograph, mapped to it (mars-dawn-kit#18).
/// 328 entries.
enum RadicalEquivalents {
    static let unifiedIdeograph: [UInt32: UInt32] = [
        ...
        0x2FD2: 0x9F52, 0x2FD3: 0x9F8D, 0x2FD4: 0x9F9C, 0x2FD5: 0x9FA0,
    ]
}
